...
Hello pals,
This is Somil Swapnil Chandra persuing btech from DITU Dehradun
...
Version Control System (VCS) is a software that helps software developers to work together and maintain a complete history of their work. VCS allows developers to work simultaneously and maintain a history record of every version. It doesn't allow overwriting each other's changes. 3. What is a version control system? How Git is a VCS?
...
GitLab BitBucket SourceForge Launchpad Google Cloud Source Repositories AWS CodeCommit Phabricator

**5. Why are you interested in learning of Git and GitHub?**

I want to learn Git and GitHub due to my curiosity and it will help me advance my knowledge. Learning Git and GitHub will help boost my potential and help  me get a better understanding of open source paradigm.
...
Hello everybody
This is Somil Swapnil Chandra and I am pursuing B-Tech from DIT University.

     The following is the  link to my git hub repository : 

https://github.com/Alankriss07/GitHub-Series
...
No, you cannot perform git commit command before git add. Git commit -a automatically adds all the files to staging area or u can say it performs a git-add.
...
Ans     :   Meaningful commit message is part of good development practice and good repository organizing.
...
Hello ,
This is Somil Swapnil Chandra ,persuing btech from DIT Dehradun and the following is my day 3 task :

 
Links

First Pull: https://github.com/codewayy/github_series/pull/16

Second pull: https://github.com/codewayy/github_series/pull/17
...
Procedure for deleting in Git Bash:
...
Scroll to the branch you want to delete, then click on the delete icon5. How can we delete a branch?
